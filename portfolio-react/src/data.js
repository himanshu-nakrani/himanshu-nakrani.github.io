...
export const kagglePinned = [
  ...
  { type: 'dataset', medal: '🥈', title: 'Iris Dataset', desc: 'Widely-used classification dataset. One of the most popular datasets on Kaggle with hundreds of downstream notebooks.', votes: 392, link: 'https://www.kaggle.com/datasets/himanshunakrani/iris-dataset' },
  ...
  { type: 'notebook', medal: null, title: 'RAG with LangChain', desc: 'Practical implementation of Retrieval-Augmented Generation using LangChain — bridging ML fundamentals with modern LLM work.', votes: 11, link: 'https://www.kaggle.com/code/himanshunakrani/rag-retrieval-augmented-generation-with-langchain' },
...
export const proofLinks = [
  { label: 'GitHub', href: 'https://github.com/himanshu-nakrani', sublabel: '26 repos' },
