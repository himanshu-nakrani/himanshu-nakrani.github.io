...
export const publications = [
  { venue: 'FLLM 2025', title: 'GoT4SQL-DA: A Graph-of-Thoughts Framework for Scalable Text-to-SQL Data Augmentation', desc: 'Novel framework leveraging Graph-of-Thoughts reasoning for scalable data augmentation in Text-to-SQL systems.', tags: ['Graph-of-Thoughts', 'Text-to-SQL', 'Data Augmentation'] },
  { venue: 'CSCI 2025', title: 'GRAFT: Graph-of-Thoughts based Reasoning and Augmentation for Finetuning Text-to-SQL', desc: 'Research on applying Graph-of-Thoughts reasoning to improve fine-tuning pipelines for Text-to-SQL generation.', tags: ['Fine-tuning', 'LLM', 'Reasoning'] },
]
