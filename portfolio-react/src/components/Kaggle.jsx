    ...
    <Section id="kaggle" title="Kaggle">
      <div ref={ref}>
        ...
        <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', marginBottom: '2rem', width: '100%' }}>
          {[
            { title: 'Datasets Expert', rank: '1,221', total: '9,064', highest: '241', silver: 3, bronze: 4 },
            { title: 'Notebooks Expert', rank: '3,003', total: '61,128', highest: '479', silver: 1, bronze: 16 },
          ].map((tier, i) => (
            <motion.div
              key={tier.title}
