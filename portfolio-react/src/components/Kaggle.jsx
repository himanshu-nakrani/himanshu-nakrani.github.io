  ...
  return (
    <Section id="kaggle" title="Kaggle">
      <div ref={ref}>
        ...
        >
<span style={{ display: 'inline-flex', alignItems: 'center', gap: 4 }}>View full Kaggle profile <span style={{ width: 4, height: 4, borderRadius: '50%', background: 'currentColor' }} /><span style={{ width: 6, height: 6, borderRadius: '50%', border: '1px solid currentColor', display: 'inline-block' }} /></span>
        </motion.a>
      </div>
      <style>{`
