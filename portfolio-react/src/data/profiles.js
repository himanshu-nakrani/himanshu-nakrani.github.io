export const kagglePinned = [
  ...
  { type: 'dataset', medal: 'Silver', title: 'Iris Dataset', desc: 'Widely-used classification dataset. One of the most popular datasets on Kaggle with hundreds of downstream notebooks.', votes: 403, link: 'https://www.kaggle.com/datasets/himanshunakrani/iris-dataset' },
  { type: 'dataset', medal: 'Silver', title: 'Student Study Hours Dataset', desc: 'Popular regression dataset for predicting student scores based on study hours. Widely used for ML tutorials.', votes: 263, link: 'https://www.kaggle.com/datasets/himanshunakrani/student-study-hours' },
