import{n as e,s as t,t as n}from"./jsx-runtime-C7M7YA1l.js";var r=t(e(),1),i=n(),a={blue:{base:220,spread:200},purple:{base:280,spread:300},green:{base:120,spread:200},red:{base:0,spread:200},orange:{base:30,spread:200}},o={sm:`w-48 h-64`,md:`w-64 h-80`,lg:`w-80 h-96`},s=`
  [data-glow]::before,
  [data-glow]::after {
    pointer-events: none;
    content: "";
...
`,c=!1,l=({children:e,className:t=``,glowColor:n=`blue`,size:l=`md`,width:u,height:d,customSize:f=!1})=>{let p=(0,r.useRef)(null),m=(0,r.useRef)(null);(0,r.useEffect)(()=>{if(!c){let e=document.createElement(`style`);e.textContent=s,document.head.appendChild(e),c=!0}},[]),(0,r.useEffect)(()=>{let e=e=>{let{clientX:t,clientY:n}=e;p.current&&(p.current.style.setProperty(`--x`,t.toFixed(2)),p.current.style.setProperty(`--xp`,(t/window.innerWidth).toFixed(2)),p.current.style.setProperty(`--y`,n.toFixed(2)),p.current.style.setProperty(`--yp`,(n/window.innerHeight).toFixed(2)))};return document.addEventListener(`pointermove`,e),()=>document.removeEventListener(`pointermove`,e)},[]);let{base:h,spread:g}=a[n],_=()=>f?``:o[l],v=()=>{let e={"--base":h,"--spread":g,"--radius":`14`,"--border":`3`,"--backdrop":`hsl(0 0% 60% / 0.12)`,"--backup-border":`var(--backdrop)`,"--size":`200`,"--outer":`1`,"--border-size":`calc(var(--border, 2) * 1px)`,"--spotlight-size":`calc(var(--size, 150) * 1px)`,"--hue":`calc(var(--base) + (var(--xp, 0) * var(--spread, 0)))`,backgroundImage:`radial-gradient(
        var(--spotlight-size) var(--spotlight-size) at
        calc(var(--x, 0) * 1px)
        calc(var(--y, 0) * 1px),
        hsl(var(--hue, 210) calc(var(--saturation, 100) * 1%) calc(var(--lightness, 70) * 1%) / var(--bg-spot-opacity, 0.1)), transparent
      )`,backgroundColor:`var(--backdrop, transparent)`,backgroundSize:`calc(100% + (2 * var(--border-size))) calc(100% + (2 * var(--border-size)))`,backgroundPosition:`50% 50%`,backgroundAttachment:`fixed`,border:`var(--border-size) solid var(--backup-border)`,position:`relative`,touchAction:`none`};return u!==void 0&&(e.width=typeof u==`number`?`${u}px`:u),d!==void 0&&(e.height=typeof d==`number`?`${d}px`:d),e};return(0,i.jsxs)(`div`,{ref:p,"data-glow":!0,style:v(),className:`
        ${_()}
        ${f?``:`aspect-[3/4]`}
        rounded-2xl
        relative
